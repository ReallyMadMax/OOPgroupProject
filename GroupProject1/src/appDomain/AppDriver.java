...
public class AppDriver {
	...
	static File shapesFile = new File("C:\\CPRG304\\assignment1StartingCode\\assignment1StartingCode\\res\\shapes1.txt");
    static File shapesFile2 = new File("C:\\CPRG304\\assignment1StartingCode\\assignment1StartingCode\\res\\shapes2.txt");
    static File shapesFile3 = new File("C:\\CPRG304\\assignment1StartingCode\\assignment1StartingCode\\res\\shapes3.txt");
	...
	public static void printByVolume(Shape[] shapes){
        ...
        for (int i = 1000; i < shapes.length; i += 1000) {
            System.out.println(i + "-th element is: " + shapes[i].getName() + " has a Volume of: " + shapes[i].calcVolume());
        }

        System.out.println("Last element is: " + shapes[shapes.length - 1].getName() + " has a Volume of: " + shapes[shapes.length - 1].calcVolume());
	}
	...
	public static void printByHeight(Shape[] shapes) {
        ...
        System.out.println("Last element is: " + shapes[shapes.length - 1].getName() + " has a Height of: " + shapes[shapes.length - 1].height);
    }

	// Method to print by base area
	public static void printByBaseArea(Shape[] shapes) {
        System.out.println("First element is: " + shapes[0].getName() + " has a Base Area of: " + shapes[0].calcBaseArea());

        for (int i = 1000; i < shapes.length; i += 1000) {
            System.out.println(i + "-th element is: " + shapes[i].getName() + " has a Base Area of: " + shapes[i].calcBaseArea());
        }

        System.out.println("Last element is: " + shapes[shapes.length - 1].getName() + " has a Base Area of: " + shapes[shapes.length - 1].calcBaseArea());
    }
				...
				case "v": // Sorting by volume
					switch (sortType.toLowerCase()) {
						...
						default:
							...
							System.out.println("Please ensure your command line argument matches one of the expected sorting algorithms.");
							System.out.println("<b> Bubble Sort / <s> Selection Sort / <i> Insertion Sort / <m> Merge Sort / <q> Quick Sort / <h> Heapsort");
							break;
					}
					break;
				...
				case "h": // Sorting by height
					switch (sortType.toLowerCase()) {
						...
						default:
							...
							System.out.println("Please ensure your command line argument matches one of the expected sorting algorithms.");
							System.out.println("Options: <b> Bubble Sort / <s> Selection Sort / <i> Insertion Sort / <m> Merge Sort / <q> Quick Sort / <h> Heapsort");
							break;
					}
					break;
